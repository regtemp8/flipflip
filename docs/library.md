...
The Library provides the ability to import sources from **Tumblr**. This
import option will appear in the sidebar after you have authorized it in [Settings](config.md).
