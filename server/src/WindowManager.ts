...
import { isLinux, isWin32 } from './utils'
...
class WindowManager {
  ...
  public initCertificateVerifyProcedure() {
  ...
  public closeLoginCodeDialog() {
    this.window.webContents.send(SDO.closeLoginCodeDialog)
  }
}
