...
test('Panning effect', async ({ page }) => {
    ...
    await expect(page.getByRole('spinbutton', { name: 'For', exact: true })).toBeVisible();
...
test('Wave panning timing', async ({ page }) => {
    ...
    const input = await container.locator('.MuiCollapse-entered .MuiTextField-root input[aria-labelledby="pan-sin-rate-slider"]')
...
test('Panning move horizontally setting', async ({ page }) => {
    await page.getByLabel('Panning', { exact: true }).check();
    await expect(page.getByLabel('Panning', { exact: true })).toBeChecked()
    const container = await page.locator('.MuiGrid2-root > .MuiGrid2-container:has-text("Move Horizontally")').nth(1)
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).not.toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).not.toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiSlider-root')).not.toBeVisible();
    ...
    await page.getByRole('option', { name: 'Left then Right', exact: true }).click();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).toBeVisible();
    ...
    await container.locator('.MuiInputBase-root:has-text("Left then Right")').first().click()
    await page.getByRole('option', { name: 'Right then Left', exact: true }).click();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiTextField-root input')).toBeVisible();

    await container.locator('.MuiInputBase-root:has-text("Right then Left")').first().click()
    await page.getByRole('option', { name: 'Random', exact: true }).click();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    ...
    await container.locator('.MuiInputBase-root:has-text("Random")').first().click()
...
test('Panning move horizontally use img width setting', async ({ page }) => {
    ...
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).not.toBeChecked();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiTextField-root input')).toBeVisible();


    await container.getByRole('checkbox', { name: 'Use Img Width', exact: true }).check();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).toBeChecked();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).not.toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiSlider-root')).not.toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiTextField-root input')).not.toBeVisible();

    await container.getByRole('checkbox', { name: 'Use Img Width', exact: true }).uncheck();
    await expect(container.getByRole('checkbox', { name: 'Use Img Width', exact: true })).not.toBeChecked();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiTextField-root input')).toBeVisible();
...
test('Panning move vertically setting', async ({ page }) => {
    await page.getByLabel('Panning', { exact: true }).check();
    await expect(page.getByLabel('Panning', { exact: true })).toBeChecked()
    const container = await page.locator('.MuiGrid2-root > .MuiGrid2-container:has-text("Move Vertically")').nth(1)
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).not.toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).not.toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiSlider-root')).not.toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiTextField-root input')).not.toBeVisible();
    ...
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiTextField-root input')).toBeVisible();

    await container.locator('.MuiInputBase-root:has-text("Up then Down")').first().click()
    ...
    await container.locator('.MuiInputBase-root:has-text("Down then Up")').first().click()
    await page.getByRole('option', { name: 'Random', exact: true }).click();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).toBeVisible();
    await expect(container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
...
test('Panning move vertically use img height setting', async ({ page }) => {
    ...
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).toBeVisible();
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).not.toBeChecked();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiTextField-root input')).toBeVisible();


    await container.getByRole('checkbox', { name: 'Use Img Height', exact: true }).check();
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).toBeChecked();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).not.toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiSlider-root')).not.toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiTextField-root input')).not.toBeVisible();

    await container.getByRole('checkbox', { name: 'Use Img Height', exact: true }).uncheck();
    await expect(container.getByRole('checkbox', { name: 'Use Img Height', exact: true })).not.toBeChecked();
    await expect(container.getByRole('checkbox', { name: 'Randomize', exact: true })).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiSlider-root')).toBeVisible();
    await expect(await container.locator('.MuiCollapse-entered .MuiTextField-root input')).toBeVisible();
