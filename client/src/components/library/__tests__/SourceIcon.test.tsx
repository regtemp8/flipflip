...
describe('SourceIcon', () => {
  ...
  it('should render icon with className prop', async () => {
    ...
    const svg = await component.root.findByType('svg')
    expect(svg.props.className).toContain(className)
  })
  it('should render Reddit icon with red color, because source is unsupported', async () => {
    const component = renderer.create(
      <TestProvider store={store}>
        <SourceIcon type={ST.reddit} />
      </TestProvider>
    ...
    const svg = await component.root.findByType('svg')
    expect(svg.props.style.color).toEqual('red')
  })
  it('should render Twitter icon with red color, because source is unsupported', async () => {
    const component = renderer.create(
      <TestProvider store={store}>
        <SourceIcon type={ST.twitter} />
      </TestProvider>
  ...
  it('should render Sex.com icon with red color, because source is unsupported', async () => {
    const component = renderer.create(
      <TestProvider store={store}>
        <SourceIcon type={ST.sexcom} />
      </TestProvider>
