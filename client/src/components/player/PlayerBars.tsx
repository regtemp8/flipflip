...
function TagCard(props: TagCardProps) {
  ...
  const isPlayerTag = false //useAppSelector(selectAppPlayerTagsIncludes(props.sceneID, props.tagID))
...
//   const videoVolume = useAppSelector(selectSceneVideoVolume(props.sceneID))
  ...
  const libraryID = 0 //useAppSelector(selectSceneLibraryID(props.sceneID))
  const audioEnabled = false //useAppSelector(selectSceneAudioEnabled(props.sceneID))
  const canInheritClipTags = false //useAppSelector(selectAppPlayerCanInheritClipTags(props.sceneID))
