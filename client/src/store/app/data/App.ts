...
function toClipStorage(id: number, state: RootState): ClipStorage {
...
function toTagStorage(id: number, state: RootState): TagStorage {
...
export function fromTagStorage(s: TagStorage, tagSlice: EntryState<Tag>) {
