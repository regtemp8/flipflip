          ...
          for (let filter of filters) {
            if (filter === '<Marked>') {
              ...
              if (filter.startsWith('-')) {
                ...
                if (filter.length === 0) {
                  matchesFilter =
                    source.artist != null && source.artist.length > 0
                } else {
              ...
              if (filter.startsWith('-')) {
                ...
                if (filter.length === 0) {
                  matchesFilter =
                    source.album != null && source.album.length > 0
                } else {
              ...
              if (filter.startsWith('-')) {
                ...
                if (filter.length === 0) {
                  matchesFilter =
                    source.comment != null && source.comment.length > 0
                } else {
                  const regex = new RegExp(filter.replace('\\', '\\\\'), 'i')
                  matchesFilter = !regex.test(source.comment as string)
                }
              } else {
                if (filter.length === 0) {
              ...
              const artist = source.artist as string
              const album = source.album as string
              if (filter.startsWith('-')) {
