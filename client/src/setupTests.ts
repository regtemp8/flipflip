...
//       canChangeSource: boolean
//     ) => {},
//     saveTextFile: (defaultPath: string, text: string) => Promise.resolve(""),
...
//     cachePath: (baseDir: string, source?: string, typeDir?: string) =>
//       Promise.resolve(""),
...
//     outputFile: (path: string, data: string | ArrayBuffer) => Promise.resolve(),
...
//     igUserFeedItems: (username: string) =>
//       Promise.resolve({ items: [], feed: "user" }),
//     igGetMore: (session: string, id: number | undefined, feedSession: string) =>
//       Promise.resolve(),
//     igFollowingFeed: (userId: number) =>
//       Promise.resolve({ items: [], feed: "following" }),
...
//     parseMusicMetadataFile: (url: string, cachePath: string) =>
//       Promise.resolve(""),
//     parseMusicMetadataBpm: (url: string) => Promise.resolve(0),
//     parseMusicMetadataBuffer: (arrayBuffer: ArrayBuffer, cachePath: string) =>
//       Promise.resolve(0),
...
//       authorizeUrl: string
//     ) => Promise.resolve(0),
//     redditOAuth: (deviceID: string, userAgent: string, clientID: string) =>
//       Promise.resolve(0),
