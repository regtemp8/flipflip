...
import { RF, RT } from '../../renderer/data/const'
...
import { getTagEntries, selectTags } from '../tag/selectors'
...
export const selectCurrentImageTags = (
  currentImage: HTMLImageElement | HTMLVideoElement | HTMLIFrameElement | undefined
) => {
...
export const getLibrarySourceEntries = (state: RootState) => state.librarySource.entries
