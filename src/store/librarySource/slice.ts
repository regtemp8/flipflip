...
import { getLibrarySource } from '../app/selectors'
...
export const librarySourceSlice = createSlice({
  name: 'librarySources',
  // `createSlice` will infer the state type from the `initialState` argument
  initialState: initialLibrarySourceState,
  reducers: {
...
export const {
  ...
  setLibrarySourceRedditTime,
  setLibrarySourceBlacklist
} = librarySourceSlice.actions

export default librarySourceSlice.reducer
