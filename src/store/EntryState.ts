...
export function isEntry<T extends Identifiable> (state: EntryState<T>, id: number) {
...
export function deleteEntry<T extends Identifiable> (state: EntryState<T>, id: number) {
  if (isEntry(state, id)) {
