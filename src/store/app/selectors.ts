...
import { SP, ST } from '../../renderer/data/const'
import { filterSource } from '../../renderer/data/utils'
...
import { selectLibrarySources, getLibrarySourceEntries } from '../librarySource/selectors'
...
export const selectAppTagsCount = () => (state: RootState): number => state.app.tags.length
...
export const selectAppLibrarySearchOptions = (
  ...
  return createSelector(
    ...
    (
      ...
      if (onlyUsed !== true) {
        appTags.map((id) => tagEntries[id]).forEach((t) => tags.set(t.name, 0))
      }
      ...
      for (const source of librarySources) {
        ...
        const type = source?.url !== undefined ? en.get(getSourceType(source.url)) : undefined
        if (type !== undefined) {
      ...
      for (const tag of tagKeys) {
        const opt = isCreatable === true || withBrackets === true ? '[' + tag + ']' : tag
      ...
      if (onlyTags !== true && noTypes !== true) {
        for (const type of typeKeys) {
          const opt = isCreatable === true || withBrackets === true ? '{' + type + '}' : type
          if (!filters.includes(opt)) {
            options.push({
...
export const selectAppThemeMode = () => {
  return (state: RootState): boolean => {
    return state.app.theme.palette.mode === 'dark'
  }
}

export const selectAppThemePalettePrimaryMain = () => {
  return (state: RootState): string => {
    const primary = state.app.theme.palette.primary as SimplePaletteColorOptions
    return primary.main
  }
}
...
export const selectAppThemePaletteSecondaryMain = () => {
  return (state: RootState): string => {
    const secondary = state.app.theme.palette.secondary as SimplePaletteColorOptions
...
const getAppSystemSnackSeverity = (state: RootState) => state.app.systemSnackSeverity

export const selectAppSystemSnack = () => {
  return createSelector(
    [getAppSystemSnackMessage, getAppSystemSnackOpen, getAppSystemSnackSeverity],
    (message, open, severity) => { return {message, open, severity}}
  )
}
...
export const selectAppConfigGeneralSettingsConfirmBlacklist = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.confirmBlacklist
}
...
export const selectAppConfigGeneralSettingsPortableMode = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.portableMode
}

export const selectAppConfigGeneralSettingsDisableLocalSave = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.disableLocalSave
}

export const selectAppConfigGeneralSettingsAutoBackup = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.autoBackup
}

export const selectAppConfigGeneralSettingsAutoCleanBackup = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.autoCleanBackup
}

export const selectAppConfigGeneralSettingsAutoBackupDays = () => {
  return (state: RootState): number => state.app.config.generalSettings.autoBackupDays
}
...
export const selectAppConfigGeneralSettingsCleanRetain = () => {
  return (state: RootState): number => state.app.config.generalSettings.cleanRetain
}

export const selectAppConfigDisplaySettingsEasingControls = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.easingControls
}

export const selectAppConfigDisplaySettingsAlwaysOnTop = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.alwaysOnTop
}

export const selectAppConfigDisplaySettingsShowMenu = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.showMenu
}

export const selectAppConfigDisplaySettingsFullScreen = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.fullScreen
}

export const selectAppConfigDisplaySettingsStartImmediately = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.startImmediately
}

export const selectAppConfigDisplaySettingsClickToProgress = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.clickToProgress
}
...
export const selectAppConfigDisplaySettingsAudioAlert = () => {
  return (state: RootState): boolean => state.app.config.displaySettings.audioAlert
}
...
export const selectAppConfigDisplaySettingsIgnoredTags = () => {
  return (state: RootState): string[] => state.app.config.displaySettings.ignoredTags
}

export const selectAppConfigDisplaySettingsMinImageSize = () => {
  return (state: RootState): number => state.app.config.displaySettings.minImageSize
}

export const selectAppConfigDisplaySettingsMinVideoSize = () => {
  return (state: RootState): number => state.app.config.displaySettings.minVideoSize
}

export const selectAppConfigDisplaySettingsMaxInHistory = () => {
  return (state: RootState): number => state.app.config.displaySettings.maxInHistory
}

export const selectAppConfigDisplaySettingsMaxInMemory = () => {
  return (state: RootState): number => state.app.config.displaySettings.maxInMemory
}

export const selectAppConfigDisplaySettingsMaxLoadingAtOnce = () => {
  return (state: RootState): number => state.app.config.displaySettings.maxLoadingAtOnce
}

export const selectAppConfigGeneralSettingsWatermark = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.watermark
}

export const selectAppConfigGeneralSettingsWatermarkGrid = () => {
  return (state: RootState): boolean => state.app.config.generalSettings.watermarkGrid
}

export const selectAppConfigGeneralSettingsWatermarkCorner = () => {
  return (state: RootState): string => state.app.config.generalSettings.watermarkCorner
}
...
export const selectAppConfigGeneralSettingsWatermarkColor = () => {
  return (state: RootState): string => state.app.config.generalSettings.watermarkColor
}

export const selectAppConfigGeneralSettingsWatermarkText = () => {
  return (state: RootState): string => state.app.config.generalSettings.watermarkText
}
...
export const selectAppConfigGeneralSettingsWatermarkSettings = (
  ...
  return createSelector(
    ...
    (gridView, enabled, isGrid, fontFamily, fontSize, color, text, corner) => {
      const settings: WatermarkSettings = enabled && (!gridView || isGrid)
...
export const selectAppConfigRemoteSettingsTumblrKeys = () => {
  return (state: RootState): string[] => state.app.config.remoteSettings.tumblrKeys
}
...
export const selectAppConfigRemoteSettingsTumblrSecrets = () => {
  return (state: RootState): string[] => state.app.config.remoteSettings.tumblrSecrets
}

export const selectAppConfigRemoteSettingsTumblrSecret = () => {
  return (state: RootState): string => state.app.config.remoteSettings.tumblrSecret
}
...
export const selectAppConfigRemoteSettingsRedditClientID = () => {
  return (state: RootState): string => state.app.config.remoteSettings.redditClientID
}

export const selectAppConfigRemoteSettingsRedditUserAgent = () => {
  return (state: RootState): string => state.app.config.remoteSettings.redditUserAgent
}

export const selectAppConfigRemoteSettingsRedditDeviceID = () => {
  return (state: RootState): string => state.app.config.remoteSettings.redditDeviceID
}
...
export const selectAppConfigRemoteSettingsInstagramConfigured = () => {
  return (state: RootState): boolean => {
    const settings = state.app.config.remoteSettings
    return settings.instagramUsername !== '' && settings.instagramPassword !== ''
  }
}

export const selectAppConfigRemoteSettingsInstagramUsername = () => {
  return (state: RootState): string => state.app.config.remoteSettings.instagramUsername
}

export const selectAppConfigRemoteSettingsInstagramPassword = () => {
  return (state: RootState): string => state.app.config.remoteSettings.instagramPassword
}
...
export const selectAppConfigRemoteSettingsHydrusProtocol = () => {
  return (state: RootState): string => state.app.config.remoteSettings.hydrusProtocol
}

export const selectAppConfigRemoteSettingsHydrusDomain = () => {
  return (state: RootState): string => state.app.config.remoteSettings.hydrusDomain
}

export const selectAppConfigRemoteSettingsHydrusPort = () => {
  return (state: RootState): string => state.app.config.remoteSettings.hydrusPort
}

export const selectAppConfigRemoteSettingsHydrusAPIKey = () => {
  return (state: RootState): string => state.app.config.remoteSettings.hydrusAPIKey
}
...
export const selectAppConfigRemoteSettingsPiwigoProtocol = () => {
  return (state: RootState): string => state.app.config.remoteSettings.piwigoProtocol
}

export const selectAppConfigRemoteSettingsPiwigoHost = () => {
  return (state: RootState): string => state.app.config.remoteSettings.piwigoHost
}

export const selectAppConfigRemoteSettingsPiwigoUsername = () => {
  return (state: RootState): string => state.app.config.remoteSettings.piwigoUsername
}

export const selectAppConfigRemoteSettingsPiwigoPassword = () => {
  return (state: RootState): string => state.app.config.remoteSettings.piwigoPassword
}
...
export const selectAppConfigDefaultSceneOrderFunction = () => {
  return (state: RootState): string => state.app.config.defaultScene.orderFunction
}
...
export const selectAppLastRouteIsConfig = () => {
  return (state: RootState): boolean => getAppLastRoute(state.app)?.kind === 'config'
}
...
export const getLibrarySource = (state: RootState): LibrarySource | undefined => {
...
export const getScriptSource = (state: RootState): CaptionScript | undefined => {
  const activeScene = getActiveScene(state)
  return activeScene !== undefined
...
export const selectAppPlayerTags = (sceneID: number) => (state: RootState): number[] | undefined => {
  const route = getAppLastRoute(state.app)
  const isLibraryPlay = route !== undefined && getAppIsRoute(route, 'libraryplay')
  if (!isLibraryPlay) {
    return undefined
  }
...
export const selectAppPlayerTagsIncludes =
  (sceneID: number, tagID: number) => (state: RootState): boolean => {
    const tags = selectAppPlayerTags(sceneID)(state)
    return tags !== undefined && tags.includes(tagID)
  }

export const selectPlayerAllTags = () => (state: RootState): number[] | undefined => {
  const route = getAppLastRoute(state.app)
  const isLibraryPlay = route !== undefined && getAppIsRoute(route, 'libraryplay')
...
export const selectAppPlayerCanInheritClipTags = (sceneID: number) => {
  return (state: RootState): boolean => {
    ...
    const source = sources !== undefined && sources.length > 0
  ...
  return createSelector(
    ...
    (selected, stateEntries, tagEntries) => {
      ...
      for (const id of selected) {
        ...
        const tagNames = tagIDs.map((id) => tagEntries[id]?.name ?? '').filter((name) => name !== '')
        if (commonTagNames.length === 0) {
          commonTagNames = tagNames
        } else {
          commonTagNames = commonTagNames.filter((name) => tagNames.includes(name))
        }
...
export const selectAppAudioSelectedTagNames = () => {
  return selectCommonTagNames(selectAppAudioSelected(), getAudioEntries, getTagEntries)
}

export const selectAppScriptSelectedTagNames = () => {
  return selectCommonTagNames(selectAppScriptSelected(), getCaptionScriptEntries, getTagEntries)
}

export const selectAppLibrarySelectedTagNames = () => {
  return selectCommonTagNames(selectAppLibrarySelected(), getLibrarySourceEntries, getTagEntries)
}
...
const getMerges = (sources: LibrarySource[], tagEntries: Record<number, Tag>): LibrarySource[] => {
  let merges: LibrarySource[] = []
  const remainingLibrary = sources.filter((ls) => {
      return ls.url !== undefined && getSourceType(ls.url) === ST.local && ls.tags.length > 0
    })
      ...
      if (filtering) {
        ...
        for (const source of sources) {
          ...
          for (const filter of filters) {
            matchesFilter = filterSource(filter, source, null, tagEntries, sources)
            if (!matchesFilter) break
          }
          if (matchesFilter) {
