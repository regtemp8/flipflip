...
import { areWeightsValid, convertGridIDToSceneID, convertSceneIDToGridID, copy, getEffects } from '../../renderer/data/utils'
import { initialApp, toLibrarySourceStorage } from '../app/data/App'
...
export const getScene = (state: EntryState<Scene>, id: number): Scene | undefined => {
  return state.entries[id]
}

export const getSceneOrSceneSettings = (state: RootState, id?: number): Scene | SceneSettings | undefined => {
  return id !== undefined ? getScene(state.scene, id) : state.app.config.defaultScene
}

export const selectSceneFadeExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeExp
}

export const selectSceneFadeOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeOv
}

export const selectSceneFadeAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeAmp
}

export const selectSceneFadePer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadePer
}
...
export const selectSceneFadeInOut = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.fadeInOut
}

export const selectSceneFadeTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.fadeTF
}

export const selectSceneFadeDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeDuration
}
...
export const selectSceneFadeSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeSinRate
}

export const selectSceneFadeBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeBPMMulti
}

export const selectSceneFadeIOPulse = (id: number) => {
  return (state: RootState): boolean | undefined => getScene(state.scene, id)?.fadeIOPulse
}

export const selectSceneFadeIOStartAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOStartAmp
}

export const selectSceneFadeIOStartExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOStartExp
}
export const selectSceneFadeIOStartOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOStartOv
}

export const selectSceneFadeIOStartPer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOStartPer
}

export const selectSceneFadeIOEndAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOEndAmp
}

export const selectSceneFadeIOEndExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOEndExp
}
export const selectSceneFadeIOEndOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOEndOv
}

export const selectSceneFadeIOEndPer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOEndPer
}

export const selectSceneFadeIOBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOBPMMulti
}

export const selectSceneFadeIODuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIODuration
}
...
export const selectSceneFadeIOSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.fadeIOSinRate
}

export const selectSceneFadeIOTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.fadeIOTF
}

export const selectScenePanning = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.panning
}

export const selectScenePanTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.panTF
}

export const selectScenePanDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panDuration
}

export const selectScenePanDurationMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panDurationMin
}

export const selectScenePanDurationMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panDurationMax
}

export const selectScenePanSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panSinRate
}

export const selectScenePanBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panBPMMulti
}

export const selectSceneTimingTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.timingFunction
}

export const selectSceneTimingDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.timingConstant
}

export const selectSceneTimingDurationMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.timingMin
}

export const selectSceneTimingDurationMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.timingMax
}

export const selectSceneTimingSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.timingSinRate
}

export const selectSceneTimingBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.timingBPMMulti
}

export const selectSceneBackForth = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.backForth
}

export const selectSceneBackForthTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.backForthTF
}
...
export const selectSceneBackForthDurationMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.backForthMin
}

export const selectSceneBackForthDurationMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.backForthMax
}
...
export const selectSceneSlide = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.slide
}

export const selectSceneSlideTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.slideTF
}

export const selectSceneSlideDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideDuration
}
...
export const selectSceneSlideSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideSinRate
}

export const selectSceneSlideBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideBPMMulti
}

export const selectSceneStrobe = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.strobe
}

export const selectSceneStrobePulse = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.strobePulse
}

export const selectSceneStrobeTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.strobeTF
}

export const selectSceneStrobeDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeTime
}

export const selectSceneStrobeDurationMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeTimeMin
}

export const selectSceneStrobeDurationMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeTimeMax
}

export const selectSceneStrobeSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeSinRate
}

export const selectSceneStrobeBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeBPMMulti
}

export const selectSceneStrobeDelayTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.strobeDelayTF
}

export const selectSceneStrobeDelayDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeDelay
}

export const selectSceneStrobeDelayDurationMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeDelayMin
}

export const selectSceneStrobeDelayDurationMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeDelayMax
}
...
export const selectSceneStrobeColor = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.strobeColor
}

export const selectSceneStrobeColorSet = (id?: number) => {
  return (state: RootState): string[] | undefined => getSceneOrSceneSettings(state, id)?.strobeColorSet
}

export const selectSceneZoomTF = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.transTF
}

export const selectSceneZoomDuration = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transDuration
}
...
export const selectSceneZoomSinRate = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transSinRate
}

export const selectSceneZoomBPMMulti = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transBPMMulti
}

export const selectSceneFadeEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.fadeEase
}
...
export const selectSceneFadeIOEndEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.fadeIOEndEase
}

export const selectScenePanStartEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.panStartEase
}

export const selectScenePanStartExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panStartExp
}

export const selectScenePanStartOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panStartOv
}

export const selectScenePanStartAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panStartAmp
}

export const selectScenePanStartPer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panStartPer
}

export const selectScenePanEndEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.panEndEase
}

export const selectScenePanEndExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panEndExp
}

export const selectScenePanEndOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panEndOv
}

export const selectScenePanEndAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panEndAmp
}

export const selectScenePanEndPer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.panEndPer
}

export const selectSceneSlideEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.slideEase
}

export const selectSceneSlideExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideExp
}

export const selectSceneSlideOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideOv
}

export const selectSceneSlideAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideAmp
}

export const selectSceneSlidePer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slidePer
}

export const selectSceneStrobeEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.strobeEase
}

export const selectSceneStrobeExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeExp
}

export const selectSceneStrobeOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeOv
}

export const selectSceneStrobeAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeAmp
}

export const selectSceneStrobePer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobePer
}

export const selectSceneTransEase = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.transEase
}

export const selectSceneTransExp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transExp
}

export const selectSceneTransOv = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transOv
}

export const selectSceneTransAmp = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transAmp
}

export const selectSceneTransPer = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.transPer
}
...
export const selectSceneHorizTransType = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.horizTransType
}
...
export const selectSceneVertTransType = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.vertTransType
}
...
export const selectSceneVertTransLevel = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.vertTransLevel
}
...
export const selectSceneZoom = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.zoom
}

export const selectSceneZoomRandom = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.zoomRandom
}

export const selectSceneZoomStart = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.zoomStart
}

export const selectSceneZoomEnd = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.zoomEnd
}

export const selectSceneZoomStartMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.zoomStartMin
}

export const selectSceneZoomStartMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.zoomStartMax
}

export const selectSceneZoomEndMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.zoomEndMin
}

export const selectSceneZoomEndMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.zoomEndMax
}
...
export const selectSceneGifOption = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.gifOption
}

export const selectSceneVideoOption = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.videoOption
}
...
export const selectSceneImageType = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.imageType
}

export const selectSceneBackgroundType = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.backgroundType
}
...
export const selectSceneSlideType = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.slideType
}

export const selectSceneSlideDistance = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.slideDistance
}
...
export const selectSceneStrobeLayer = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.strobeLayer
}

export const selectSceneStrobeOpacity = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.strobeOpacity
}

export const selectSceneNextSceneID = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.nextSceneID
}
...
export const selectScenePersistAudio = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.persistAudio
}

export const selectScenePersistText = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.persistText
}

export const selectSceneOverlays = (id?: number) => {
  return (state: RootState): number[] | undefined => getSceneOrSceneSettings(state, id)?.overlays
}

export const selectSceneOverlayEnabled = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.overlayEnabled
}

export const selectSceneNextSceneTime = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.nextSceneTime
}

export const selectSceneBackgroundBlur = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.backgroundBlur
}

export const selectSceneRegenerate = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.regenerate
}

export const selectSceneFullSource = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.fullSource
}

export const selectSceneVideoSpeed = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoSpeed
}
...
export const selectSceneVideoSpeedMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoSpeedMin
}

export const selectSceneVideoSpeedMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoSpeedMax
}

export const selectSceneVideoSkip = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoSkip
}

export const selectSceneVideoVolume = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoVolume
}
...
export const selectSceneContinueVideo = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.continueVideo
}

export const selectScenePlayVideoClips = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.playVideoClips
}

export const selectSceneForceAllSource = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.forceAllSource
}

export const selectSceneForceAll = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.forceAll
}
...
export const selectSceneGifTimingMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.gifTimingMin
}

export const selectSceneGifTimingMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.gifTimingMax
}
...
export const selectSceneVideoTimingMin = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoTimingMin
}

export const selectSceneVideoTimingMax = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.videoTimingMax
}

export const selectSceneSkipVideoStart = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.skipVideoStart
}

export const selectSceneSkipVideoEnd = (id?: number) => {
  return (state: RootState): number | undefined => getSceneOrSceneSettings(state, id)?.skipVideoEnd
}

export const selectSceneWeightFunction = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.weightFunction
}
...
export const selectSceneOrderFunction = (id?: number) => {
  return (state: RootState): string | undefined => getSceneOrSceneSettings(state, id)?.orderFunction
}

export const selectSceneFirstSourceUrl = (id?: number) => {
  return (state: RootState): string | undefined => {
    const sources = getSceneOrSceneSettings(state, id)?.sources
    return sources !== undefined && sources.length > 0 ? state.librarySource.entries[sources[0]]?.url : ''
  }
}

export const selectSceneSources = (id?: number) => {
  return (state: RootState): number[] => getSceneOrSceneSettings(state, id)?.sources ?? []
}

export const selectSceneHasGeneratorWeights = (id?: number) => {
  return (state: RootState): boolean | undefined => {
    const scene = getSceneOrSceneSettings(state, id)
    return scene !== undefined ? scene.generatorWeights != null : undefined
  }
}

export const selectSceneCrossFade = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.crossFade
}

export const selectSceneCrossFadeAudio = (id?: number) => {
  return (state: RootState): boolean | undefined => getSceneOrSceneSettings(state, id)?.crossFadeAudio
}

export const selectSceneAudioEnabled = (id: number) => {
  return (state: RootState): boolean | undefined => getScene(state.scene, id)?.audioEnabled
}

export const selectSceneAudioPlaylists = (id: number) => {
  return (state: RootState): AudioPlaylist[] | undefined => getScene(state.scene, id)?.audioPlaylists
}

export const selectSceneScriptPlaylist = (id: number, index: number) => {
  return (state: RootState): ScriptPlaylist | undefined => getScene(state.scene, id)?.scriptPlaylists[index]
}

export const selectSceneTextEnabled = (id: number) => {
  return (state: RootState): boolean | undefined => getScene(state.scene, id)?.textEnabled
}

export const selectSceneScriptPlaylistLength = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.scriptPlaylists.length
}

export const selectSceneOpenTab = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.openTab
}

export const selectSceneName = (id: number) => {
  return (state: RootState): string | undefined => getScene(state.scene, id)?.name
}

export const selectSceneUseWeights = (id: number) => {
  return (state: RootState): boolean | undefined => getScene(state.scene, id)?.useWeights
}

export const selectSceneGeneratorWeights = (id: number) => {
  return (state: RootState): WeightGroup[] | undefined => getScene(state.scene, id)?.generatorWeights
}

export const selectSceneOverrideIgnore = (id: number) => {
  return (state: RootState): boolean | undefined => getScene(state.scene, id)?.overrideIgnore
}

export const selectSceneGeneratorMax = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.generatorMax
}

export const selectSceneIsGridScene = (id: number) => {
  return (state: RootState): boolean => getScene(state.scene, id)?.gridScene ?? false
}

export const selectSceneIsAudioScene = (id: number) => {
  return (state: RootState): boolean => getScene(state.scene, id)?.audioScene ?? false
}

export const selectSceneIsScriptScene = (id: number) => {
  return (state: RootState): boolean => getScene(state.scene, id)?.scriptScene ?? false
}

export const selectSceneIsDownloadScene = (id: number) => {
  return (state: RootState): boolean => getScene(state.scene, id)?.downloadScene ?? false
}

export const selectSceneScriptPlaylists = (id: number) => {
  return (state: RootState): ScriptPlaylist[] | undefined => getScene(state.scene, id)?.scriptPlaylists
}
...
const selectScene = (id: number) => (state: RootState) => state.scene.entries[id]
...
export const selectSceneFadeIODelayTF = (id: number) => {
  return (state: RootState): string | undefined => getScene(state.scene, id)?.fadeIODelayTF
}

export const selectSceneFadeIODelay = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.fadeIODelay
}

export const selectSceneFadeIODelayMin = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.fadeIODelayMin
}

export const selectSceneFadeIODelayMax = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.fadeIODelayMax
}

export const selectSceneFadeIODelaySinRate = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.fadeIODelaySinRate
}

export const selectSceneFadeIODelayBPMMulti = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.fadeIODelayBPMMulti
}

export const selectSceneScriptStartIndex = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.scriptStartIndex
}
...
export const selectSceneLibraryID = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.libraryID
}

export const selectSceneDisableWeightOptions = (id?: number) => {
  return (state: RootState): boolean | undefined => {
    const sources = id !== undefined ? getScene(state.scene, id)?.sources : undefined
    return sources === undefined 
      || sources.length === 0 
      || (sources.length === 1 && state.librarySource.entries[sources[0]]?.dirOfSources !== true)
  }
}

export const selectSceneAudioStartIndex = (id: number) => {
  return (state: RootState): number | undefined => getScene(state.scene, id)?.audioStartIndex
}

export const getNextScene = (state: RootState, id: number): Scene | undefined => {
  const scene = getScene(state.scene, id)
  if (scene === undefined) return undefined
  const nextID = scene.nextSceneID === -1 ? scene.nextSceneRandomID : scene.nextSceneID
  return state.scene.entries[nextID]
}
...
export const selectNextSceneSourceOrderFunction = (id: number) => {
  return (state: RootState): string | undefined => getNextScene(state, id)?.sourceOrderFunction
}

export const selectNextScenePlayVideoClips = (id: number) => {
  return (state: RootState): boolean | undefined => getNextScene(state, id)?.playVideoClips
}

export const selectNextSceneImageTypeFilter = (id: number) => {
  return (state: RootState): string | undefined => getNextScene(state, id)?.imageTypeFilter
}

export const selectNextSceneWeightFunction = (id: number) => {
  return (state: RootState): string | undefined => getNextScene(state, id)?.weightFunction
}

const getSceneName = (id: string, state: RootState): string | undefined => {
  const sceneID = Number(id)
  const gridID = convertSceneIDToGridID(sceneID)
  return gridID !== undefined
    ? state.sceneGrid.entries[gridID]?.name
    : state.scene.entries[sceneID]?.name
}
  ...
  return createSelector(
    ...
    (onlyExtra, includeExtra, includeGrids, sceneID, scenes, grids) => {
      ...
      scenes
        .filter((s) => {
          return (
            s.id !== sceneID && (s.sources.length > 0 || (s.regenerate && areWeightsValid(s)))
          )
        })
        .forEach((s) => {
...
export const selectVideoClipperScene = () => {
  return createSelector([selectScenes()], (scenes) => scenes.find((s) => s.name === videoClipperSceneName))
}

export const selectVideoClipperSceneID = () => {
  return createSelector([selectVideoClipperScene()], (scene) => scene?.id)
}

export const selectVideoClipperSceneVideoVolume = () => {
  return createSelector([selectVideoClipperScene()], (scene) => scene?.videoVolume)
}
...
export const selectSceneAudioPlaylistDuration = (
  ...
  return (state: RootState): number | undefined => {
    const audios = getScene(state.scene, id)?.audioPlaylists[playlistIndex]
      .audios
...
export const selectSceneGeneratorWeightsValid = (id: number) => {
  return (state: RootState): boolean | undefined => {
    const scene = getScene(state.scene, id)
    return scene !== undefined ? areWeightsValid(scene) : undefined
  }
}
...
export const selectSceneEffectsBase64 = (id: number) => {
  return (state: RootState): string | undefined => {
    const scene = getScene(state.scene, id)
    return scene !== undefined ? getEffects(scene) : undefined
  }
}
