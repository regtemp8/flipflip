...
function AudioLibrary(props: WithStyles<typeof styles>) {
  ...
  const onURLChange = (e: MouseEvent) => {
  ...
  const onAddSource = async (type: string, e: MouseEvent) => {
    ...
    switch (type) {
      case AF.url:
        ...
        break
      case AF.audios:
        const audioSources = await window.flipflip.api.loadAudioSources(
          e.shiftKey
        )
        if (audioSources) {
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <div className={clsx(tutorial != null && classes.disable)}>
          ...
          >
            <ListItemButton
              onClick={onAddToPlaylist.bind(this)}
              disabled={specialMode != null}
            >
              <ListItemIcon>
                <PlaylistAddIcon />
              ...
              <div className={classes.tabPanel}>
                ...
                <Box p={2} className={classes.fill}>
                  <PlaylistList
                    ...
                    onClickPlaylist={onClickPlaylist.bind(this)}
                  />
                </Box>
              </div>
            </Typography>
              ...
              <div className={classes.tabPanel}>
                ...
                <Box p={2} className={classes.fill}>
                  <AudioArtistList
                    ...
                    showHelp={!specialMode && filters.length === 0}
                    onClickArtist={onClickArtist.bind(this)}
                  />
                </Box>
              </div>
            </Typography>
              ...
              <div className={classes.tabPanel}>
                ...
                <Box p={2} className={classes.fill}>
                  <AudioAlbumList
                    sources={displaySources}
                    showHelp={!specialMode && filters.length === 0}
                    onClickAlbum={onClickAlbum.bind(this)}
                    onClickArtist={onClickArtist.bind(this)}
                  />
                </Box>
              </div>
              ...
              <div className={classes.tabPanel}>
                ...
                <Box className={classes.fill}>
                  <AudioSourceList
                    ...
                    onClickAlbum={onClickAlbum.bind(this)}
                    onClickArtist={onClickArtist.bind(this)}
                    onUpdateSelected={onUpdateSelected.bind(this)}
                  />
                </Box>
              </div>
            </Typography>
        ...
        <React.Fragment>
          <Tooltip disableInteractive title="Clear" placement="top-end">
            <Fab
              ...
              onClick={onSelectNone.bind(this)}
              size="small"
            >
            ...
            <Tooltip disableInteractive title={'Batch Tag'} placement="top-end">
              ...
              >
                <Fab
                  ...
                  onClick={onToggleBatchTagModal.bind(this)}
                  size="large"
                >
            ...
            >
              ...
              >
                <Fab
                  className={classes.addMenuButton}
                  disabled={selected.length === 0}
                  onClick={onShowBatchEditModal.bind(this)}
                  size="large"
                >
            ...
            >
              ...
              >
                <Fab
                  className={classes.addMenuButton}
                  disabled={selected.length === 0}
                  onClick={onTogglePlaylistDialog.bind(this)}
                  size="large"
                >
            ...
            <Tooltip disableInteractive title={'Import'} placement="top-end">
              ...
              >
                <Fab
                  className={classes.addMenuButton}
                  disabled={selected.length === 0}
                  onClick={onImportFromLibrary.bind(this)}
                  size="large"
                >
        ...
        <React.Fragment>
            ...
            {filters.length > 0 && playlist && (
              <React.Fragment>
                ...
                <DialogActions>
                  ...
                  <Button
                    onClick={onFinishRemovePlaylist.bind(this)}
                    color="primary"
                  >
                    Confirm
                  </Button>
          ...
          >
            <Fab
              ...
              onClick={onAddSource.bind(this, AF.audios)}
              size="small"
            >
        ...
        >
          ...
          <DialogContent className={classes.noScroll}>
            ...
            <TextField
              ...
              onChange={onURLChange.bind(this)}
            />
          </DialogContent>
          <DialogActions>
            {loadingMetadata && (
      ...
      {openMenu === MO.playlist && (
        ...
        >
          <PlaylistSelect
            menuIsOpen
            autoFocus
            onChange={onChoosePlaylist.bind(this)}
          />
        </Menu>
      )}
      ...
      {openMenu === MO.newPlaylist && (
        ...
        >
          ...
          <DialogActions>
            ...
            <Button onClick={onAddPlaylist.bind(this)} color="primary">
              Create Playlist
            </Button>
          </DialogActions>
        </Dialog>
      ...
      {openMenu === MO.playlistDuplicates && (
        ...
        >
          ...
          <DialogActions>
            <Button onClick={onSkipDuplicates.bind(this)} color="secondary">
              Skip Duplicates
            </Button>
            <Button onClick={onAddDuplicates.bind(this)} color="primary">
              Add Anyway
            </Button>
          </DialogActions>
        </Dialog>
      ...
      {openMenu === MO.batchEdit && (
        <AudioEdit
          ...
          onCancel={onCloseDialog.bind(this)}
          onFinishEdit={onFinishBatchEdit.bind(this)}
        />
      )}
          ...
          <DialogContent className={classes.noScroll}>
            ...
            {openMenu === MO.batchTag && (
              <LibrarySearch
                ...
                onUpdateFilters={onSelectTags.bind(this)}
              />
            )}
          </DialogContent>
          <DialogActions>
            <Button
              ...
              onClick={batchTagRemove.bind(this)}
              color="secondary"
            >
              - Remove
            </Button>
            <Button
              disabled={selectedTags && selectedTags.length === 0}
              onClick={batchTagAdd.bind(this)}
              color="secondary"
            >
              + Add
            </Button>
            <Button onClick={batchTagOverwrite.bind(this)} color="primary">
              Overwrite
            </Button>
          </DialogActions>
        </Dialog>
