  ...
  return (
    ...
    >
                          ...
                          <InputAdornment position="end">
                            ...
                            >
                              <IconButton
                                ...
                                onClick={onReadBPMTag.bind(this)}
                                size="large"
                              >
                                {successTag
                                  ? (
      ...
      <DialogActions className={classes.actions}>
        <Button onClick={onCancel.bind(this)} color="secondary">
          Cancel
        </Button>
        <Button onClick={props.onDone.bind(this)} color="primary">
          Save
        </Button>
      </DialogActions>
    </Dialog>
