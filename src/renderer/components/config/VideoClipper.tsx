...
function VideoClipper(props: WithStyles<typeof styles>) {
  ...
  const onTag = () => {
    dispatch(setPlayerState({uuid: 'video-clipper', value: {
      sceneID,
      nextSceneID: -1,
      overlays: [],
  ...
  const onChangeStartText = (e: MouseEvent) => {
    const input = e.target as HTMLInputElement
    dispatch(setVideoClipperEditingStartText(input.value))
    const timestampValue = getTimestampValue(input.value)
  ...
  const onChangeEndText = (e: MouseEvent) => {
    const input = e.target as HTMLInputElement
    dispatch(setVideoClipperEditingEndText(input.value))
    const timestampValue = getTimestampValue(input.value)
    onChangeStartTextValue(timestampValue)
  }
              ...
              >
                ...
                <Grid item className={classes.tagButtons}>
                  ...
                  <Tooltip
                    ...
                    placement="top"
                  >
                    <IconButton onClick={onTag.bind(this)} size="large">
                      <KeyboardReturnIcon />
                    </IconButton>
                  </Tooltip>
                </Grid>
                ...
                >
                  <VideoControl
                    ...
                    useHotkeys
                    onChangeVolume={onChangeVolume.bind(this)}
                  />
                </Grid>
              </Grid>
            )}
                      ...
                      {clips.map((clipID, index) => (
                        <Grid key={clipID} item>
                          <Button
                            ...
                            onClick={onEdit.bind(this, clipID)}
                          >
                            {index + 1}
                          </Button>
                        </Grid>
                    ...
                    >
                        ...
                        <Grid item>
                          ...
                          >
                            <Fab
                              ...
                              onClick={onToggleClip.bind(this)}
                            >
                      ...
                      <Grid item>
                        <TextField
                          ...
                          onDoubleClick={onClickStartText.bind(this)}
                          onChange={onChangeStartText.bind(this)}
                        />
                      </Grid>
                      <Grid item>
                        <TextField
                          ...
                          onDoubleClick={onClickEndText.bind(this)}
                          onChange={onChangeEndText.bind(this)}
                        />
                      </Grid>
                      <Grid item>
                        <Tooltip
                      ...
                      <Grid item>
                        ...
                        >
                          <Fab
                            ...
                            onClick={onSetVolume.bind(this)}
                            onContextMenu={onClearVolume.bind(this)}
                          >
