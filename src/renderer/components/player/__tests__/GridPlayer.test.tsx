...
import { PlayerOverlayState, PlayersState, setPlayersState } from "../../../../store/player/slice";
...
describe("GridPlayer", () => {
  it("should match snapshot", () => {
    ...
    store.dispatch(setSceneGrid(newSceneGrid({id: sceneID, grid: [[newSceneGridCell({sceneID: 1})]]})))
