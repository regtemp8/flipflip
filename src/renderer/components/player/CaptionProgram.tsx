...
export default function CaptionProgram (props: CaptionProgramProps) {
        ...
        switch (command) {
          ...
          case 'count':
            ...
            if (timestamp != null) {
              ...
              const actions = newTimestamps.get(timestamp)
              if (actions) {
                actions.push(count(start, end, true))
              } else {
                newTimestamps.set(timestamp, [count(start, end, true)])
              }
            } else {
              containsAction = true
              newProgram.push(count(start, end))
            }
            break
          case 'blink':
          case 'cap':
          case 'bigcap':
            ...
            if (timestamp != null) {
              ...
              const actions = newTimestamps.get(timestamp)
              if (actions) {
                actions.push(this[command](value, true))
              } else {
                newTimestamps.set(timestamp, [this[command](value, true)])
              }
            } else {
              containsAction = true
          ...
          case 'storeAudio':
            ...
            if (
              ...
              !(await window.flipflip.api.pathExists(file))
            ) {
              error =
                'Error: {' +
                index +
          ...
          case 'playAudio':
            ...
            fn = this[command](pSplit[0], volume)
            if (timestamp != null) {
              containsTimestampAction = true
              const actions = newTimestamps.get(timestamp)
              if (actions) {
          ...
          case 'setCountColorMatch':
            ...
            fn = this[command](value === 'true' || value === 't')
            if (timestamp != null) {
              const actions = newTimestamps.get(timestamp)
              if (actions) {
                actions.push(fn)
  ...
  const cap = (value: string, timestamp = false) => {
    return (nextCommand: Function) => {
      const command = () => {
  ...
  const bigcap = (value: string, timestamp = false) => {
    return (nextCommand: Function) => {
      const command = () => {
        if (state.countProgress) {
          setState({ ...state, countProgress: false })
  ...
  const blink = (value: string, timestamp = false) => {
    return (nextCommand: Function) => {
      const command = () => {
        if (state.countProgress) {
          setState({ ...state, countProgress: false })
  ...
  const count = (start: number, end: number, timestamp = false) => {
    ...
    return (nextCommand: Function) => {
      const command = () => {
        ...
        if (state.showCountProgress) {
          offset = state.countProgressOffset ? Math.min(origStart, origEnd) : 0
          setState({
            ...state,
            countProgress: true,
  ...
  const playAudio = (alias: string, volume: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkY = (relYPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setCaptionY = (relYPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setBigCaptionY = (relYPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountY = (relYPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkX = (relXPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setCaptionX = (relXPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setBigCaptionX = (relXPos: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountX = (relXPos: number) => {
    return (nextCommand: Function) => {
  ...
  /* Blink */
  const setBlinkDuration = (ms: number[]) => {
    return (nextCommand: Function) => {
      if (ms.length === 1) {
  ...
  const setBlinkWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkDelayWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkDelayBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkDelayTF = (tf: string) => {
    return (nextCommand: Function) => {
  ...
  /* Blink Group Delay */
  const setBlinkGroupDelay = (ms: number[]) => {
    return (nextCommand: Function) => {
      if (ms.length === 1) {
  ...
  const setBlinkGroupDelayWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkGroupDelayBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkGroupDelayTF = (tf: string) => {
    return (nextCommand: Function) => {
  ...
  /* Caption */
  const setCaptionDuration = (ms: number[]) => {
    return (nextCommand: Function) => {
      if (ms.length === 1) {
  ...
  const setCaptionWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setCaptionBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  /* Caption Delay */
  const setCaptionDelay = (ms: number[]) => {
    return (nextCommand: Function) => {
      if (ms.length === 1) {
  ...
  const setCaptionDelayWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setCaptionDelayBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setCaptionDelayTF = (tf: string) => {
    return (nextCommand: Function) => {
  ...
  /* Count */
  const setCountDuration = (ms: number[]) => {
    return (nextCommand: Function) => {
      if (ms.length === 1) {
  ...
  const setCountWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountDelayWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountDelayBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountDelayTF = (tf: string) => {
    return (nextCommand: Function) => {
  ...
  /* Count Group Delay */
  const setCountGroupDelay = (ms: number[]) => {
    return (nextCommand: Function) => {
      if (ms.length === 1) {
  ...
  const setCountGroupDelayWaveRate = (waveRate: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountGroupDelayBPMMulti = (bpmMulti: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountGroupDelayTF = (tf: string) => {
    return (nextCommand: Function) => {
  ...
  const setShowCountProgress = (show: boolean) => {
    return (nextCommand: Function) => {
  ...
  const setCountProgressScale = (scale: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountProgressColor = (args: any[]) => {
    return (nextCommand: Function) => {
  ...
  const setCountProgressOffset = (offset: boolean) => {
    return (nextCommand: Function) => {
  ...
  const setCountColorMatch = (match: boolean) => {
    return (nextCommand: Function) => {
  ...
  const setBlinkOpacity = (opacity: number) => {
    return (nextCommand: Function) => {
  ...
  const setCaptionOpacity = (opacity: number) => {
    return (nextCommand: Function) => {
  ...
  const setCountOpacity = (opacity: number) => {
    return (nextCommand: Function) => {
