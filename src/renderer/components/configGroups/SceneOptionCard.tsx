...
import { BT, IT, SDT } from '../../data/const'
            ...
            <Grid container spacing={2} alignItems="center">
              ...
              >
                ...
                <Dialog
                  ...
                  onClose={onRandomSceneDialog.bind(this)}
                ...
                >
                  <DialogContent classes={{ root: classes.noScroll }}>
                    ...
                    <MultiSceneSelect
                      ...
                      onChange={changeRandomScenes.bind(this)}
                    />
                  </DialogContent>
                  <DialogActions>
                    <Button onClick={onSelectNone.bind(this)}>
                      Select None
                    </Button>
                    <Button onClick={onSelectAll.bind(this)}>Select All</Button>
                  </DialogActions>
                  <DialogActions>
                    <Button
                      onClick={onRandomSceneDialog.bind(this)}
                      color="secondary"
                    >
                      Cancel
                    </Button>
                    <Button
                      onClick={onSaveRandomScene.bind(this)}
                      color="primary"
                    >
                      Save
                    </Button>
          ...
          <Grid item>
            <Collapse in={overlayEnabled}>
              <Fab
                ...
                onClick={onAddOverlay.bind(this)}
                size="small"
              >
                <AddIcon />
              </Fab>
