...
function BackupCard(props: WithStyles<typeof styles>) {
  ...
  const refreshBackups = () => {
    window.flipflip.api.getBackups().then((backups) => {
      setBackups(backups)
    })
  }

  const onChangeBackup = (e: MouseEvent) => {
    const input = e.target as HTMLInputElement
    setBackup(backups.find((b) => b.url === input.value))
  }
    ...
    <React.Fragment>
      ...
      >
          ...
          {backup && (
            <FormControl variant="standard">
              ...
              <Select
                ...
                onChange={onChangeBackup.bind(this)}
              >
                {backups.map((b) => (
        ...
        <DialogActions>
          ...
          <Button onClick={onFinishRestore.bind(this)} color="primary">
            Restore
          </Button>
        </DialogActions>
      </Dialog>
