...
import { AF, MO, SDGT, SDT, SF, SP, SS, ST, TT, WF } from '../../data/const'
...
function SceneDetail(props: SceneDetailProps) {
  ...
  const onKeyDown = (e: KeyboardEvent) => {
    if (
      ...
      setOpenMenu(openMenu === MO.gooninatorImport ? null : MO.gooninatorImport)
    }
  }
  ...
  const onToggleNewMenu = () => {
    ...
    setOpenMenu(openMenu === MO.new ? null : MO.new)
  }
  ...
  const onCopySceneEffects = () => {
    window.flipflip.api.copyTextToClipboard(sceneEffects)
    setConfirmCopy(true)
    setTimeout(() => {
  ...
  const onChangeSceneEffects = (e: MouseEvent) => {
    const input = e.target as HTMLInputElement
    setSceneEffects(input.value)
  }
  ...
  const endEditingName = (e: Event) => {
    e.preventDefault()
    dispatch(setSceneName({ id: props.sceneID, value: isEditingName }))
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          {isEditingName != null && (
            <form
              onSubmit={endEditingName.bind(this)}
            ...
            >
              <TextField
                ...
                onBlur={endEditingName.bind(this)}
          ...
          {isEditingName == null && (
            <React.Fragment>
              ...
              <Typography
                ...
                onClick={beginEditingName.bind(this)}
              >
                {name}
              </Typography>
              <div className={classes.fill} />
          ...
          {openTab === 3 && (
            <div className={classes.librarySearch}>
              <LibrarySearch
                ...
                isCreatable
                onlyUsed
                onUpdateFilters={onUpdateFilters.bind(this)}
              />
            </div>
          )}
      ...
      >
        ...
        <ListItem className={classes.drawerButton}>
          <IconButton onClick={onToggleDrawer.bind(this)} size="large">
        ...
        <div>
          ...
          >
            <ListItem
              button
              onClick={onOpenSceneEffectsMenu.bind(this)}
              className={clsx(
                (tutorial === SDT.options1 || tutorial === SDT.effects1) &&
                  classes.disable
              )}
          ...
          <Tooltip disableInteractive title={drawerOpen ? '' : 'Delete Scene'}>
            <ListItemButton
              onClick={onDeleteScene.bind(this)}
              className={clsx(
                classes.deleteItem,
                (tutorial === SDT.options1 || tutorial === SDT.effects1) &&
                  classes.disable
          ...
          >
            ...
            <DialogActions>
              ...
              <Button onClick={onFinishDeleteScene.bind(this)} color="primary">
                OK
              </Button>
            </DialogActions>
          </Dialog>
      ...
      >
        ...
        <DialogContent>
          <TextField
            ...
            onChange={onChangeSceneEffects.bind(this)}
          />
        </DialogContent>
        <DialogActions>
          <Button onClick={onCopySceneEffects.bind(this)} color="secondary">
            {confirmCopy && <CheckCircleIcon className={classes.confirmCopy} />}
            Copy to Clipboard
          </Button>
          <Button onClick={onApplySceneEffects.bind(this)} color="primary">
            Apply
          </Button>
        </DialogActions>
      </Dialog>
        ...
        <React.Fragment>
            ...
            {filters.length === 0 && (
              <React.Fragment>
                ...
                <DialogActions>
                  ...
                  <Button
                    onClick={onFinishRemoveAll.bind(this)}
                    color="primary"
                  >
                    OK
                  </Button>
            ...
            {filters.length > 0 && (
              <React.Fragment>
                ...
                <DialogActions>
                  ...
                  <Button
                    onClick={onFinishRemoveVisible.bind(this)}
                    color="primary"
                  >
                    OK
                  </Button>
          ...
          {piwigoConfigured && (
            <Tooltip disableInteractive title="From Piwigo" placement="left">
              <Fab
                ...
                onClick={onOpenPiwigoMenu.bind(this)}
                size="small"
              >
          ...
          <Tooltip disableInteractive title="From Library" placement="left">
            <Fab
              ...
              onClick={onAddSource.bind(this, AF.library)}
              size="small"
            >
          ...
          >
            <Fab
              ...
              onClick={onAddSource.bind(this, AF.videos)}
              size="small"
            >
          ...
          <Tooltip disableInteractive title="Local Directory" placement="left">
            <Fab
              ...
              onClick={onAddSource.bind(this, AF.directory)}
              size="small"
            >
          ...
          <Tooltip disableInteractive title="URL" placement="left">
            <Fab
              ...
              onClick={onAddSource.bind(this, AF.url)}
              size="small"
            >
          ...
          <GooninatorDialog
            ...
            onImportURL={onAddSource.bind(this)}
            onClose={onCloseDialog.bind(this)}
          />
          <URLDialog
            ...
            <React.Fragment>
              {weightFunction === WF.sources && (
                <Fab
                  ...
                  onClick={onToggleWeight.bind(this)}
                  size="medium"
                >
        ...
        <React.Fragment>
            ...
            <React.Fragment>
              ...
              >
                ...
                <DialogActions>
                  ...
                  <Button
                    onClick={onFinishRemoveAllRules.bind(this)}
                    color="primary"
                  >
                    OK
                  </Button>
          ...
          >
            <Fab
              ...
              onClick={onToggleOverrideIgnore.bind(this)}
              size="medium"
            >
          ...
          <Tooltip disableInteractive title="Max" placement="top">
            <Fab
              ...
              onClick={onOpenMaxMenu.bind(this)}
              size="medium"
            >
              {generatorMax}
            </Fab>
          ...
          <Tooltip disableInteractive title="Adv Rule" placement="left">
            <Fab
              ...
              onClick={onAddAdvRule.bind(this)}
              size="small"
            >
          ...
          <Tooltip disableInteractive title="Simple Rule" placement="left">
            <Fab
              ...
              onClick={onOpenTagMenu.bind(this)}
              size="small"
            >
              <AddIcon className={classes.icon} />
            </Fab>
      ...
      <Snackbar
        ...
        onClose={onCloseSnackbar.bind(this)}
